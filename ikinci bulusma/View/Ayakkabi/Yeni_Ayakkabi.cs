...
{
    public partial class Yeni_Ayakkabi : Form
    {
        int gorev = 0;
        ayakkabi ayakkabi = new ayakkabi();
        public Yeni_Ayakkabi()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
         ...
         /*   int count_form = Application.OpenForms.Count;
            ...
            Ayakkabi_Anaform anaform = (Ayakkabi_Anaform)Application.OpenForms["Ayakkabi_Anaform"];
            if (gorev==1)
            {
        ...
        {
            Yeni_Ayakkabi ayakkabi = new Yeni_Ayakkabi();
            ayakkabi.Show();
            ayakkabi.Hide();
